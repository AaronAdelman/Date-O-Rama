...
//    lazy var ISODateFormatter = ISO8601DateFormatter()
    ...
    public class func newRow(dictionary:  Dictionary<String, String?>) -> ASARow {
        ...
        if calendarCode != nil {
//            newrow.calendar.calendarCode = ASACalendarCode(rawValue: calendarCode!!)!
...
//        temp.calendarCode = ASACalendarCode.Gregorian
    ...
    func copy() -> ASARow {
        let tempRow = ASARow()
//        temprow.calendar.calendarCode = self.calendarCode
...
//
//        return result
        return self.calendar.dateString(now: now, LDMLString: LDMLString, location: nil)
