            ...
            VStack(spacing: 0.0) {
                ...
                List {
                    ...
                    case .byPlaceName, .byCountry:
                        ASAMainClocksByPlaceView(primaryGroupingOption: self.primaryMainRowsGroupingOption, secondaryGroupingOption: $secondaryMainRowsGroupingOption, rows: $userData.mainRows, now: $now)
