//
//  ASADailyJewishEventSource.swift
//  Date-O-Rama
//
...
class ASADailyJewishEventSource:  ASAInternalEventSource {
    var eventSourceCode: ASAInternalEventSourceCode = .dailyJewish
...
//            ASAEvent(title: NSLocalizedString(OTHER_DUSK_KEY, comment: ""), startDate: previousOtherDusk, endDate: previousOtherDusk, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ...
            ASAEvent(title: NSLocalizedString(RECOGNITION_KEY, comment: ""), startDate: recognition, endDate: recognition, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ...
            ASAEvent(title: NSLocalizedString(OTHER_HOUR_03_KEY, comment: ""), startDate: otherHour03, endDate: otherHour03, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(HOUR_03_KEY, comment: ""), startDate: hour03, endDate: hour03, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(OTHER_HOUR_04_KEY, comment: ""), startDate: otherHour04, endDate: otherHour04, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(HOUR_04_KEY, comment: ""), startDate: hour04, endDate: hour04, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(NOON_KEY, comment: ""), startDate: hour06, endDate: hour06, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(HOUR_06½_KEY, comment: ""), startDate: hour06½, endDate: hour06½, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(OTHER_HOUR_06½_KEY, comment: ""), startDate: otherHour06½, endDate: otherHour06½, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(HOUR_09½_KEY, comment: ""), startDate: hour09½, endDate: hour09½, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(OTHER_HOUR_09½_KEY, comment: ""), startDate: otherHour09½, endDate: otherHour09½, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(HOUR_10¾_KEY, comment: ""), startDate: hour10¾, endDate: hour10¾, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(OTHER_HOUR_10¾_KEY, comment: ""), startDate: otherHour10¾, endDate: otherHour10¾, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
            ASAEvent(title: NSLocalizedString(CANDLELIGHTING_KEY, comment: ""), startDate: candelLighting, endDate: candelLighting, isAllDay: false, timeZone: timeZone, color: calendarColor(), calendarTitle:  eventCalendarName),
